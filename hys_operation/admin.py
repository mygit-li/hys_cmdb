...
class MachineInfoAdmin(admin.ModelAdmin):
    ...
    def get_list_filter(self, request):
        ...
        if request.user.is_superuser or \
            ...
            self.list_filter = ('idc', 'status', 'machine_group__group_name')
        else:
            self.list_filter = ()
    ...
    fieldsets = [
        (None, {'fields': [('machine_model', 'machine_ip', 'machine_os', 'application')]}),
        ('硬信息*', {'fields': [('cache', 'cpu', 'hard_disk', 'status')]}),
    ...
    def get_form(self, request, obj=None, **kwargs):
        ...
        if request.user.is_superuser:
            self.fieldsets = ((None, {'fields': ('project_name', 'to_mail', 'data_selected', 'proposer', 'frequency',
                                                 'commit_date', 'start_date', 'end_date', 'paper_num', 'sql', 'mark',
                                                 'is_sure', 'is_expired', ), }),)
        else:
